      ...
      <section className="bg-[#f7f8fb] pt-[118px] md:pt-[132px]">
        <div className="relative overflow-visible bg-[#f7f8fb]">
          ...
          <SiteContainer className="relative">
            <div className="relative -mt-20 mb-8 max-w-[40rem] overflow-hidden px-5 py-5 text-white shadow-[0_25px_100px_rgba(0,0,0,0.15)] md:-mt-28 md:px-6 md:py-6 lg:-mt-32 lg:px-7">
